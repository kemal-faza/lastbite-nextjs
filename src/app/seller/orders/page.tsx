...
import { ArrowLeftIcon, PackageIcon, ClockIcon, SpinnerIcon, PhoneIcon } from '@phosphor-icons/react';
      ...
      {!isCompleted && (
        <div className="flex gap-2 pt-1">
          {nextAction && (
            ...
            >
              {isActioning ? <SpinnerIcon className="w-3.5 h-3.5 animate-spin" /> : null}
              {nextAction.label}
            </button>
          )}
          <button
